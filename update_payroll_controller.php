...
file_put_contents('c:\laragon\www\bioenterprise_api\app\Http\Controllers\PayrollController.php', $phpCode);
echo "PayrollController.php actualizado para consultar solo empleados ACTIVOS de la empresa correspondiente.\n";
