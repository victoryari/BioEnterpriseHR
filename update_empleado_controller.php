...
file_put_contents('c:\laragon\www\bioenterprise_api\app\Http\Controllers\EmpleadoController.php', $phpCode);
echo "EmpleadoController.php actualizado con los métodos store y destroy.\n";
